...
export class Game {
    ...
    */
    get client_entities() {
        const ret = wasm.game_client_entities(this.ptr);
    ...
    */
    add_player(socket_id) {
        wasm.game_add_player(this.ptr, socket_id);
    }
    /**
    * @param {number} socket_id
    */
    remove_player(socket_id) {
        wasm.game_remove_player(this.ptr, socket_id);
    }
    /**
    * @param {number} socket_id
    ...
    */
    set_player_input(socket_id, step_forward, step_backward, step_left, step_right) {
        wasm.game_set_player_input(this.ptr, socket_id, step_forward, step_backward, step_left, step_right);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('albo_server_bg.wasm', import.meta.url);
    }
    const imports = getImports();
